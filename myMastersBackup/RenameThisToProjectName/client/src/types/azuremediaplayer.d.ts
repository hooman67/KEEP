...
declare module amp {
    ...
    interface Player {
      ...
      options (): Player.Options;
         ...
         * @return The [[amp.Player]] calling this function.
         */
      src (newSource: Player.Source, tracks?: Array<Player.Track>): Player;
         ...
         * @return The [[amp.Player]] calling this function.
         */
      src (newSources: Array<Player.Source>, textTracks?: Array<Player.Track>): Player;
      ...
      playbackRate (value: number): Player;
         ...
         */
      downloadableMedia (): Array<amp.Player.DownloadableMediaFile>;
      downloadableMedia (value: Array<amp.Player.DownloadableMediaFile>): Player;
      ...
      playlist (): PlayList;
         ...
         */
      addMidRoll (newMidRoll: MidRoll): Array<MidRoll>;

        /**
         * Returns newly seen splices, evt: "splicewaiting"
         *
         */
      spliceWaiting (): Array<Splice>;
      ...
      currentClip (): Clip;
         ...
         */
      presentationLayout ();
      presentationLayout (value: PresentationLayout);
    }
...
declare module amp.Player {
    ...
    interface Options {
      ...
      plugins?: any;
        ...
        /**
         * CorsConfig to set whether text track and poster requires crossOrigin policy set to anonymous or useCredential.
         */
      corsPolicyForTextTracksAndPoster?: CorsConfig;
    }
    ...
    interface TraceConfig {
         ...
         */
      TraceTargets?: Array<TraceTarget>;
    ...
    interface PlaybackSpeedOptions {
      ...
      initialSpeed?: number;
         ...
         */
      speedLevels?: Array<KeyValuePair<number>>;
    }
