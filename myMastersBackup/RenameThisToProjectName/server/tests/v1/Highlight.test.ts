...
describe('Highlight API End Point Unit Test', () => {
  describe('GET /lesson/:id/highlights', () => {
    before((done) => {
    ...
    it('Reject Request: Empty Account', (done) => {
      chai.request(server)
        .get('/api/v1/lesson/00000000-0001-0000-0000-000000000001/highlights')
    ...
    it('Reject Request: Student Account & Invalid Lesson', (done) => {
      chai.request(server)
        .get('/api/v1/lesson/00000000-0001-0000-0000-000000000003/highlights')
  ...
  describe('POST /lesson/:id/highlights', () => {
    before((done) => {
      InitTestDatabase(done);
    });
    ...
    it('Reject Request: Empty Account', (done) => {
      chai.request(server)
        .post('/api/v1/lesson/00000000-0001-0000-0000-000000000001/highlights')
        .set('UserUUID', '00000000-0000-0000-0001-000000000003')
        .end((err, res) => {
          res.should.have.status(401);
          res.body.message.should.equal('Unauthorized Access');
    ...
    it('Reject Request: Student Account & Invalid Lesson', (done) => {
      chai.request(server)
        .post('/api/v1/lesson/00000000-0001-0000-0000-000000000003/highlights')
        .set('UserUUID', '00000000-0000-0000-0001-000000000001')
        .end((err, res) => {
          res.should.have.status(404);
          res.body.message.should.equal('Resource Not Found');
    ...
    it('Approve Request: Student Account & Subscriber & Correct Data Type', (done) => {
      chai.request(server)
        ...
        .end(async (err, res) => {
          ...
          userLessonQueryData.Highlights.should.be.a('array');
          userLessonQueryData.Highlights.length.should.equal(3);
          _.isEqual(userLessonQueryData.Highlights[0].toObject(), expectResult0).should.equal(true);
          _.isEqual(userLessonQueryData.Highlights[1].toObject(), expectResult1).should.equal(true);
          _.isEqual(userLessonQueryData.Highlights[2].toObject(), expectResult2).should.equal(true);
          done();
        });
    });
  ...
  describe('DELETE /lesson/:id/highlights', () => {
    before((done) => {
      InitTestDatabase(done);
    });
    ...
    it('Reject Request: Empty Account', (done) => {
      chai.request(server)
        .del('/api/v1/lesson/00000000-0001-0000-0000-000000000001/highlights')
        .set('UserUUID', '00000000-0000-0000-0001-000000000003')
        .end((err, res) => {
          res.should.have.status(401);
          res.body.message.should.equal('Unauthorized Access');
    ...
    it('Reject Request: Student Account & Invalid Lesson', (done) => {
      chai.request(server)
        .del('/api/v1/lesson/00000000-0001-0000-0000-000000000003/highlights')
        .set('UserUUID', '00000000-0000-0000-0001-000000000001')
        .end((err, res) => {
          res.should.have.status(404);
          res.body.message.should.equal('Resource Not Found');
    ...
    it('Approve Request: Student Account & Subscriber & Valid UUID', (done) => {
      chai.request(server)
        ...
        .end(async (err, res) => {
          ...
          const userLessonQueryData = <IUserLessonSchema> await userLessonModel.findById('0b2d6f0734391d7ca8794c413c0c1ffba65411721473fb466757a51d390a4e10');
          userLessonQueryData.Highlights.should.be.a('array');
          userLessonQueryData.Highlights.length.should.equal(2);
          _.isEqual(userLessonQueryData.Highlights[0].toObject(), expectResult0).should.equal(true);
          _.isEqual(userLessonQueryData.Highlights[1].toObject(), expectResult1).should.equal(true);
          done();
        });
